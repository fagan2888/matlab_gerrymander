...
parameterlist3=sprintf('imputeduncontested=%f symm=%i statelabel=%s outputfilename=%s',imputeduncontested,symm,state_label,outputfilename);
parameterlisting=[parameterlist1 parameterlist2 parameterlist3]; clear parameterlist1 parameterlist2 parameterlist3
switch 1
    case year==0
...
fprintf(fid,['<i>' parameterlisting '</i><br>\n<br>\n']);
